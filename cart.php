...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 <?php  
if (!isset($_GET['id'])) {
	//echo "<meta http-equiv = 'refresh' content ='0;URL=?id=justen' />";
}
 ?>
			...
			<div class="cartpage">
					...
					<td>
						<form action="" method="post">
							...
							<input type="number" name="quantity" value="<?php echo $result['quantity']; ?>"min="1" max="<?php echo $result['variant_stock']; ?>"/>
