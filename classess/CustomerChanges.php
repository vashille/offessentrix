...
private $fm;
	...
	$newpassword_md5 = md5($newpassword);
			...
			//check old password
	$sql = "SELECT * FROM tbl_customer WHERE id  = '$id ' AND pass = '$oldpassword_md5'";
				...
				//if old password is correct
				 if ($result != false) {
						...
						$query = "UPDATE tbl_customer SET pass = '$newpassword_md5' WHERE id  = '$id '";
...
public function changeCustomerForgotPassword($newpass,$code,$email){

		$newpassword_md5 = md5($newpass);

	//change old password to new pasword
	$query = "UPDATE tbl_customer SET pass= '$newpassword_md5' WHERE email  = '$email'";
