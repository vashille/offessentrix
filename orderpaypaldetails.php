...
<div class="topnav">
 ...
 <a  href="orderdetails.php">Cash on Delivery</a>
  <a  href="orderbitcoindetails.php">Bitcoin</a>
  <a class="active" href="orderpaypaldetails.php">Paypal</a>
...
if (isset($_GET['customerId'])) {
    ...
    $confirm = $paypal->productShippedPaypalConfirm($id);
    	...
    	<div class="section group">
    		<div class="order">
                ...
                <table class="tblone">
                            ...
                            $getOrder = $paypal->getOrderedProductPaypal($cmrId);
                            if ($getOrder) {
                                $i = 0;
